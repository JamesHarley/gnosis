    ...
    render() {
        return (
            ...
            <div id="Home">
                ...
                <h5><i className="fas fa-diagnoses"></i> Application Design and Development </h5>
                ...
                <Icons />   
                    ...
                    <p className="card-text  text-center ">Wether you need a completely custom product,  or you need support for your current web and mobile products, Gnosis Development offers low prices with superior quality.</p>
                    <br /><br />
